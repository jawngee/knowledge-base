                ...
                <tr>
                    <td class="toggle">
                        <div class="ic-Super-toggle--on-off">
                            <?php echo $__env->make('base/fields/checkbox', ['name' => 'mcloud-network-mode', 'value' => $networkMode, 'description' => '', 'conditions' => null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="title">
                            Network Mode
                        </div>
                ...
                <tr>
                    <td class="toggle">
                        <div class="ic-Super-toggle--on-off <?php echo e(($tool->envEnabled() && !$tool->enabled()) ? 'toggle-warning' : ''); ?>">
                            <?php echo $__env->make('base/fields/enable-toggle-checkbox', ['name' => $key, 'tool' => $tool], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="title">
                    ...
                    <td class="description">
                        <?php echo $__env->make('base/fields/enable-toggle-description', ['name' => $key, 'tool' => $tool, 'manager' => $manager], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </td>
                </tr>
...
<?php echo $__env->make('../templates/sub-page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/www/kb.mediacloud.press/current/web/app/plugins/ilab-media-tools/views/base/features.blade.php ENDPATH**/ ?>