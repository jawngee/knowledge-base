<div class="ic-Super-toggle--on-off">
    <input type="checkbox" id="<?php echo e($name); ?>" name='<?php echo e($name); ?>' class="ic-Super-toggle__input" <?php echo e((($value) ? 'checked' : '')); ?> <?php echo e((!$enabled) ? 'disabled' : ''); ?>>
...
<?php /**PATH /srv/www/kb.mediacloud.press/current/web/app/plugins/ilab-media-tools/views/base/ui/checkbox.blade.php ENDPATH**/ ?>